...
class OperacaoSaldoIntegridadeControllerTest {
    ...
    void rejeitaVendaExcedenteCom422SemPersistir() throws Exception {
        Carteira carteira = carteiras.saveAndFlush(new Carteira("Carteira saldo", "CARTEIRA SALDO", null));
        ...
        mockMvc.perform(post("/operacoes").contentType(MediaType.APPLICATION_JSON).content(corpo))
